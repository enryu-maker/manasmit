      ...
      <div className="mx-auto max-w-full px-2 sm:px-6 lg:px-8 sticky top-0 bg-gray-50 w-full z-50">
        <div className="relative flex h-16 w-full items-center justify-end">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            {/* Mobile menu button */}
            <DisclosureButton className="group sticky top-0 inline-flex items-center justify-center rounded-md p-2  text-black focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
